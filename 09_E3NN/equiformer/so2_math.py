...
def get_alignment_angles(edge_vec: torch.Tensor):
    """
    ...
    """
    r = edge_vec.norm(dim=-1, keepdim=False)
...
def rotate_to_global_frame(features_by_l, alpha, beta, gamma, lmax):
    ...
    for l in range(lmax + 1):
        D_inv = o3.wigner_D(l, inv_alpha, inv_beta, inv_gamma)
        f_l = features_by_l[l]
